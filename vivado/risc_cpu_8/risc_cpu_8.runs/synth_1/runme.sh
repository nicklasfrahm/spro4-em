...
HD_PWD='C:/Users/Nicklas Frahm/Desktop/GitLab/Uni/spro4-em/vivado/risc_cpu_8/risc_cpu_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc_controller_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc_controller_8.tcl
