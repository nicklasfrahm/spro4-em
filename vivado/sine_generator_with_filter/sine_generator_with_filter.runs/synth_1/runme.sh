...
HD_PWD='C:/Users/Nicklas Frahm/Desktop/GitLab/Uni/spro4-em/vivado/sine_generator_with_filter/sine_generator_with_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_wave_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sine_wave_gen.tcl
